...
const Team = () => {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Mobile Layout - Show 1 member at a time with next/prev */}
        ...
        <div className="w-9/12">
          ...
          >
            <div className="relative h-[300px] overflow-hidden">
              ...
              <div className="absolute w-9/12 top-[40px] left-[70px]">
                <img
                  src={players[index].image}
                  alt={players[index].name}
                  className="border-4 border-white object-center rounded-full w-[250px] h-[250px]"
                />
              </div>
            </div>
